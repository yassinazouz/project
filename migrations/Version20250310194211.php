 ...
 */
final class Version20250310194211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders_details (quantity INT NOT NULL, price INT NOT NULL, orders_id INT NOT NULL, livres_id INT NOT NULL, INDEX IDX_835379F1CFFE9AD6 (orders_id), INDEX IDX_835379F1EBF07F38 (livres_id), PRIMARY KEY(orders_id, livres_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
